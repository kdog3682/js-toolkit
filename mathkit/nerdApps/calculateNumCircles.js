...
function calculator(ref) {
    ...
    function runner(ref) {
        ...
        // but it is also one that can be fed into a feedback loop
...
function calculateNumCircles(width = 140, radius = 10, spacing = null) {
    if (spacing == null) {
        spacing = radius
    }
    const ref = {
