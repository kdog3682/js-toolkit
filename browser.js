...
function elt(o) {
    ...
    function getTag(o) {
        if (o.attributes) {
            if (o.attributes.download) {
                return "a"
            }

            if (o.attributes.href) {
    ...
    const tag = o.tag || getTag(o)
    const element = document.createElement(tag)
    if (o.className) {
        element.className = o.className
    }
    if (o.attributes) {
        for (let [k, v] of Object.entries(o.attributes)) {
    ...
    if (o.style) {
        Object.assign(element.style, o.style)
    }
...
function getKeyAndType(e) {
    const keypressDict = {
      ...
      "Backspace": {"name": "backspace", "type": "actionKey"},
